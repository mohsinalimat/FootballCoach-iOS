...
+(instancetype)newStrategy {
    return [[TeamStrategy alloc] initWithName:@"Balanced" description:@"Play a normal offense with no bonus either way, but no penalties either." rPref:1 pPref:1 runPot:0 passPot:0 runProt:0 passProt:0 rUsg:1 pUsg:1];
}
