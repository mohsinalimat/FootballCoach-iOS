//
//  PlayerLBDetailViewController.m
//  harbaughsim16
//
...
@interface PlayerLBDetailViewController ()

@end

@implementation PlayerLBDetailViewController

-(instancetype)initWithPlayer:(PlayerLB*)player {
