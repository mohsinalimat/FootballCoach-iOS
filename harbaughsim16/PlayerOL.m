...
-(void)advanceSeason {
    ...
    _ratOLPow += (int)([HBSharedUtils randomValue]*(self.ratPot + self.gamesPlayed - 35))/10;
    _ratOLBkR += (int)([HBSharedUtils randomValue]*(self.ratPot + self.gamesPlayed - 35))/10;
    _ratOLBkP += (int)([HBSharedUtils randomValue]*(self.ratPot + self.gamesPlayed - 35))/10;
    if ([HBSharedUtils randomValue]*100 < self.ratPot ) {
        //breakthrough
        _ratOLPow += (int)([HBSharedUtils randomValue]*(self.ratPot + self.gamesPlayed - 40))/10;
        _ratOLBkR += (int)([HBSharedUtils randomValue]*(self.ratPot + self.gamesPlayed - 40))/10;
        _ratOLBkP += (int)([HBSharedUtils randomValue]*(self.ratPot + self.gamesPlayed - 40))/10;
    }
