...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row >= heismanHistory.count || indexPath.row >= leagueHistory.count) {
        ...
        heisman = heismanHistory[[NSString stringWithFormat:@"%ld", (long)(2017 + indexPath.row)]];
        leagueYear = leagueHistory[[NSString stringWithFormat:@"%ld", (long)(2017 + indexPath.row)]];
    }
