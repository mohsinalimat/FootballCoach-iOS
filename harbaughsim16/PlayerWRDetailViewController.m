//
//  PlayerWRDetailViewController.m
//  harbaughsim16
//
...
@interface PlayerWRDetailViewController ()

@end

@implementation PlayerWRDetailViewController
-(instancetype)initWithPlayer:(PlayerWR*)player {
    ...
    if (indexPath.section == 0) {
        ...
        if ((selectedPlayer.year > 4 && selectedPlayer.isGradTransfer == NO) || selectedPlayer.draftPosition != nil) {
            if (indexPath.row == 0) {
                ...
                [cell.detailTextLabel setText:careerStats[@"recYardsPerGame"]];
                [cell.textLabel setText:@"Yards Per Game"];
            } else if (indexPath.row == 8) {
                [cell.detailTextLabel setText:careerStats[@"recTouchdowns"]];
            ...
            if (indexPath.row == 0) {
                ...
                [cell.detailTextLabel setText:stats[@"recYardsPerGame"]];
                [cell.textLabel setText:@"Yards Per Game"];
            } else if (indexPath.row == 4) {
                [cell.detailTextLabel setText:stats[@"recTouchdowns"]];
                [cell.textLabel setText:@"Touchdowns"];
            } else {
