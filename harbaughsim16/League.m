...
//        [conferences addObject:[Conference newConferenceWithName:@"SOUTH" fullName:@"Southern" league:self]]; // SEC
//        [conferences addObject:[Conference newConferenceWithName:@"LAKES" fullName:@"Lakes" league:self]]; // B1G
//        [conferences addObject:[Conference newConferenceWithName:@"NORTH" fullName:@"North" league:self]]; // Big East
//        [conferences addObject:[Conference newConferenceWithName:@"COWBY" fullName:@"Cowboy" league:self]]; // Big 12
//        [conferences addObject:[Conference newConferenceWithName:@"PACIF" fullName:@"Pacific" league:self]]; // PAC 12
//        [conferences addObject:[Conference newConferenceWithName:@"MOUNT" fullName:@"Mountain" league:self]]; // MWC
//
//        [conferences addObject:[Conference newConferenceWithName:@"GULF" fullName:@"Gulf Coast" league:self]]; // Sun Belt
//        [conferences addObject:[Conference newConferenceWithName:@"NWAC" fullName:@"Northwest" league:self]]; // WAC
//        [conferences addObject:[Conference newConferenceWithName:@"MDATL" fullName:@"Mid Atlantic" league:self]]; // ACC
//        [conferences addObject:[Conference newConferenceWithName:@"PLNS" fullName:@"Plains" league:self]]; // Mid-American
//        [conferences addObject:[Conference newConferenceWithName:@"ESATH" fullName:@"Eastern Athletic" league:self]]; // AAC
//        [conferences addObject:[Conference newConferenceWithName:@"MSRVR" fullName:@"Mississippi River" league:self]]; // CUSA
...
-(NSString*)getHeismanCeremonyStr {
    if (heisman != nil && heismanWinnerStrFull != nil && heismanWinnerStrFull.length != 0) {
        ...
        if ([heisman isKindOfClass:[PlayerQB class]]) {
            ...
            [heismanStats appendString:[NSString stringWithFormat:@"%@\n\nFull Results: %@",heismanWinnerStr, heismanTop5]];
        } else if ([heisman isKindOfClass:[PlayerDL class]]) {
            PlayerDL *heis = (PlayerDL*)heisman;
            ...
            heismanWinnerStr = [NSString stringWithFormat:@"%ld's POTY: %@ DL %@!\n?Congratulations to %@ DL %@ [%@], who had %@ and led %@ to a %ld-%ld record and a #%ld poll ranking.",(long)([HBSharedUtils currentLeague].baseYear + self.leagueHistoryDictionary.count), heis.team.abbreviation, [heis getInitialName],heis.team.abbreviation, heis.name, [heis getYearString], [self _cleanListString:statString numberOfParts:parts],heis.team.name, (long)heis.team.wins,(long)heis.team.losses,(long)heis.team.rankTeamPollScore];
            [heismanStats appendString:[NSString stringWithFormat:@"%@\n\nFull Results: %@",heismanWinnerStr, heismanTop5]];
