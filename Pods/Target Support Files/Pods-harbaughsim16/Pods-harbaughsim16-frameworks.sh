...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AutoCoding-iOS10.0/AutoCoding.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Charts-iOS10.0/Charts.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/GBDeviceInfo-iOS10.0/GBDeviceInfo.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/RSEmailFeedback-iOS10.0/RSEmailFeedback.framework"
